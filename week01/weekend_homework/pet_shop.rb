...
def remove_pet_by_name(pet_shop, name_string)
  ...
  # trying a different way to specify the pet collection
  #
  #
# this deletes the first pet with that name only
  pets = pet_shop[:pets]

  pet = find_pet_by_name(pet_shop, name_string)
  pets.delete(pet)

# this will delete all pets with a given name
  # for pet in pets
