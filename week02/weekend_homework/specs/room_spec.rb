...
class TestRoom < MiniTest::Test
  ...
  def test_guest_cannot_enter_room__room_full
    ...
    @room.enter(@guest)
    assert_equal([@guest, @another_guest], @room.guest_list )
  end
  ...
  def test_room_can_store_guest_bar_tab
    # maybe turn the guest list into a hash
    # with the key as the guest
    # and the value their bar tab
    #or have onr tab per room?
  end
